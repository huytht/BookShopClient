        ...
        >
          <Paper elevation={0} style={{}}>
            ...
            >
              ...
              <a style={{ fontWeight: "bold" }}>{_product.publisher?.name}</a> <br />
              <label>Thể loại: </label>
              {_product.category?.map((item, index) => <a style={{ fontWeight: "bold" }} >{item}{index !== _product.category?.length - 1 ? ", " : " "}</a>)}  
              <br />
              <label style={{ display: "flex" }}>
                Đánh giá: {_product.rate} <StarBorderOutlinedIcon />
              </label>
              <DESCSUMARY>
